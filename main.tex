...
\patchcmd{\@maketitle}{\LARGE \@title}{\fontsize{13.5}{19.2}\selectfont\@title}{}{}
\makeatother
...
% $P_i$.
The section \textit{\nameref{sec:probability}} describes how to combine QED
with DFT to obtain $P_i$.
...
The following section \textit{\nameref{sec:sputtering}} considers the evolution of
the excited states during the sputtering process to derive $\{E_d\}$ and $P_f$.
...
given in the subsections \textit{\nameref{sec:hBN}} and
\textit{\nameref{sec:MoS2}}.
